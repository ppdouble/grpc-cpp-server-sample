...
const uint32_t TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, _impl_.myname_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloResponse, _impl_.responsemsg_),
};
...
const char descriptor_table_protodef_helloworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ld.HelloResponse\"\000B(\n\024nd.pxample.pemo.gr"
  "pcB\nHelloWorld\242\002\003HLWb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_helloworld_2eproto = {
    false, false, 228, descriptor_table_protodef_helloworld_2eproto,
    "helloworld.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloRequest.myname"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* HelloRequest::_InternalSerialize(
  ...
  if (!this->_internal_myname().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "helloworld.HelloRequest.myname");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_myname(), target);
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloResponse.responseMsg"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* HelloResponse::_InternalSerialize(
  ...
  if (!this->_internal_responsemsg().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "helloworld.HelloResponse.responseMsg");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_responsemsg(), target);
  }
